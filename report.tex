...
Open/Closed - \texttt{Renderer} hierarchy

\subsubsection{\texttt{ChargeShape} and \texttt{QuarterShape} Abstraction}%
...
\subsubsection{Renderer (Figure~\ref{fig:RendererUML})}%
\label{ssub:renderer}

\subsubsection{ChargeRenderer (Figure~\ref{fig:RendererUML})}%
\label{ssub:chargerenderer}

\subsubsection{QuarterRenderer (Figure~\ref{fig:RendererUML})}%
\label{ssub:quarterrenderer}

\subsubsection{AShape and AQuarterShape (Figure~\ref{fig:AShapeUML})}%
\label{ssub:ashape_and_aquartershape}

\subsubsection{ChargeShapes (Figure~\ref{fig:ChargeShapesUML})}%
\label{ssub:chargeshapes}

\subsubsection{QuarterShapes}%
\label{ssub:quartershapes}
