...
\marginnote{UML diagrams for all classes mentioned in this subsection can be found in
Appendix~\ref{sec:second_design_iteration_diagrams}.} \texttt{\ublazon} took 2 arguments in its
